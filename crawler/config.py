...
REGIONS = [
    ...
    # --- #93 확대: 20대 밀집·패션 상권 위주 10개 동 추가 (id는 브라우저에서 확인한 값) ---
    {"name": "서교동", "in_param": "서교동-230"},
    {"name": "연남동", "in_param": "연남동-234"},
    {"name": "창천동", "in_param": "창천동-6119"},
    {"name": "안암동", "in_param": "안암동-125"},
    {"name": "회기동", "in_param": "회기동-97"},
    {"name": "행당동", "in_param": "행당동-6143"},
    {"name": "흑석동", "in_param": "흑석동-331"},
    {"name": "성수동2가", "in_param": "성수동2가-6141"},
    {"name": "한남동", "in_param": "한남동-50"},
    {"name": "공덕동", "in_param": "공덕동-223"},
]
