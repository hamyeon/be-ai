...
INCLUDE = {
    ...
    13242: ("Converse", "Chuck 70", "Black"),              # 척70 대표 표준 컬러
}
...
EXCLUDE = {
    ...
    318934: "스탠스미스 데콘 화이트그린 - 같은 변형 라인",
    86588: "스탠스미스 80s - 복각 프리미엄 라인, 체결 69k~275k 스프레드 4배",
    # 결론: KREAM 검색 상위가 전부 변형 라인이라 스탠스미스 기본형 참조는 확보 불가.
    # 기본형은 상시 할인 판매라 리셀 체결이 적은 모델로 보인다 - 참조 없이 둔다.
}
